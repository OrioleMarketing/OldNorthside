...
export function AboutPage() {
  return <main><PageHero eyebrow="The Dewenter-Greenen House" title="A Romanesque Revival home with a living Indianapolis story." copy="Old Northside Bed and Breakfast sits in the heart of one of the city’s most distinctive historic neighborhoods." /><section className="section section--paper"><div className="container editorial-grid"><div><p className="eyebrow eyebrow--gold">Since 1885</p><h2 className="font-display">An old house with a generous welcome.</h2><p>Built for industrialist Herman Dewenter in 1885, the house is an enduring part of Indianapolis’s Old Northside. The home later became a small, personal inn—one where Romanesque Revival architecture, art, and hospitality all share the same address.</p><p>Today, seven private-bath rooms make room for a measured, more thoughtful kind of stay. The innkeeper’s local perspective, breakfast on your schedule, and small comforts help make arrival easy.</p><Link className="inn-button inn-button--dark" href="/booking">Plan a stay <ArrowRight size={17}/></Link></div><img src="/manus-storage/exterior_3b0e8c31.jpg" alt="Old Northside Bed and Breakfast historic red-brick exterior" /></div></section><section className="section section--ink"><div className="container mini-facts"><div><MapPin/><span><strong>Old Northside</strong>Indianapolis, Indiana</span></div><div><Coffee/><span><strong>Breakfast</strong>Served at your chosen time</span></div><div><CheckCircle2/><span><strong>Seven rooms</strong>Each with a private bath</span></div></div></section></main>;
}
