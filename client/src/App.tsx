...
function App() {
  return <ErrorBoundary><ThemeProvider defaultTheme="light"><TooltipProvider><Toaster /><div className="site-shell"><SiteHeader /><Router /><SiteFooter /></div></TooltipProvider></ThemeProvider></ErrorBoundary>;
}
